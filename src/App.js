...
function App() {
  ...
  return (
      ...
      mx-auto" style={{"width":"400", "backgroundColor":"white", "marginTop":"15px"}}>
      ...
      <h5 className="card text-white bg-dark mb-3">Add Your Task</h5>
        ...
        <button className="btn btn-outline-primary mx-2 mb-2 mb-3" style={{'borderRadius':'50px',"font-weight":"bold"}} onClick= {addTodoHandler} >Add Task</button>
        </span>
